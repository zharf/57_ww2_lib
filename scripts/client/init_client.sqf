...
switch (KP_liberation_arsenal) do {
	...
	case 7: {[] call compileFinal preprocessFileLineNumbers "arsenal_presets\WWII.sqf";};
...
// hack to add pylon configuring ability for the misconfigured LIB_OpelBlitz_Ammo
